...
macOS menu bar app for managing local LLM models (GGUF + MLX). Swift (~5000 lines across 5 files) + bash CLI (~710 lines). Written by Roland Chia. Version 0.92b (beta).
