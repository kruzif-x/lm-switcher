...
COMPILED_BIN="$BIN_DIR/llm-switcher"
...
echo "==> Compiling llm-switcher (multi-file module)..."
...
cp "$COMPILED_BIN" "$APP_BUNDLE/Contents/MacOS/llm-switcher"
...
codesign --force --sign - "$APP_BUNDLE/Contents/MacOS/llm-switcher" 2>/dev/null || true
...
<dict>
    ...
    <array>
        <string>$APP_BUNDLE/Contents/MacOS/llm-switcher</string>
    </array>
    <key>RunAtLoad</key>
    <true/>
    <key>KeepAlive</key>
