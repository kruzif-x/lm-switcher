...
> **Beta — v0.9.2b.** This is an early release of LM Switcher. The core model management
...
Current: **v0.9.2b** — beta. Menu bar + Per-Model redesign, MCP agent access, idle auto-unload, oMLX + MTPLX backends. (Matches `CFBundleShortVersionString` in `scripts/install.sh`.)
