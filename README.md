...
> **Beta — v0.9.4b.** This is an early release of LM Switcher. The core model management
...
Current: **v0.9.4b** — beta. Menu bar + Per-Model redesign, MCP agent access, idle auto-unload, oMLX + MTPLX + DS4 backends. (Matches `CFBundleShortVersionString` in `scripts/install.sh`.)
