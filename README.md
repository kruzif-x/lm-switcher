...
> **Beta — v0.9.6b.** This is an early release of LM Switcher. The core model management
...
Current: **v0.9.6b** — beta. Menu bar + Per-Model redesign, MCP agent access, idle auto-unload, six engines (llama.cpp, MLX, oMLX, MTPLX, DS4, mlx-serve), and an in-app engine-selection map. (Matches `CFBundleShortVersionString` in `scripts/install.sh`.)
